 ...
 * 接口。
 */
public class DailyFragment extends Fragment implements PullToRefreshView.OnRefreshListener {
    ...
    private DailyRecyclerViewAdapter mRecyclerViewAdapter;

    private DataSource mDataSource;
    private DailyContent mDailyContent;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        mPullToRefreshView = (PullToRefreshView) inflater.
                inflate(R.layout.fragment_daily, container, false);
        ...
        Runnable createView = new Runnable() {
            ...
            public void run() {
                ...
                mDailyContent = new DailyContent();
                mLoadDataTask = new AsynLoadData(0);
                mLoadDataTask.execute();

                // 设置适配器。
                mRecyclerViewAdapter = new DailyRecyclerViewAdapter(mDailyContent.ITEMS, inflater, mListener);
    ...
    public interface OnListFragmentInteractionListener {
        // TODO: 更新参数类型及名称。
        void onDailyListScroll();
        void onDailyListUpdate(final int updateCount);
        void onDailyItemClick(DailyArticleItem dailyArticleItem);
    }
    ...
    private class AsynLoadData extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... voids) {
            ...
            return mDailyContent.update(mDataSource
                    .getDailyContent(mRequestOffset, mRequestLimit), mRequestOffset != 0);
        }
        ...
        protected void onPostExecute(Integer integer) {
            ...
            if (integer != 0) {
                mListener.onDailyListUpdate(integer);
